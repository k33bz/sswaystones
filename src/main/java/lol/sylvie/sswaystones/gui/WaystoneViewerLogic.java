...
/**
 * Viewer-GUI decisions extracted as pure functions so they can be unit-tested without
...
public final class WaystoneViewerLogic {
    ...
    /** Number of pages for {@code count} entries, at least 1 (an empty list still shows page 1). */
    ...
    /**
     * Whether an entry may be forgotten (right-click): non-global, not the viewer's own, and still
     * tracked by storage.
     */
    ...
    /**
     * The "Right-click: Forget" lore hint uses a looser rule than {@link #canForget} — it can't
     * cheaply consult the storage map while building 45 lore lines.
     */
